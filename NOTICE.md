...
The project makes no claim that prompt authoring alone can reproduce a full runtime framework, eliminate OOC behavior, or make arbitrary models indistinguishable from humans. Any reported benefit must be limited to controlled comparisons under the same model and host conditions.
